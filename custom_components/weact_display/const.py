...
CMD_FULL                   = 0x04
CMD_SEND_BITMAP            = 0x05
CMD_ENABLE_HUMITURE_REPORT = 0x06
CMD_INIT_SCREEN            = 0x07
CMD_TERMINATOR             = 0x0A
CMD_SEND_BITMAP_FASTLZ     = 0x15
...
FIXED_PACKET_LENGTHS = {
    CMD_READ_ORIENTATION : 3,  # [0x82][value][0x0A]
    CMD_READ_BRIGHTNESS  : 3,  # [0x83][value][0x0A]
    CMD_HUMITURE_REPORT  : 6,  # [0x86][T_low][T_high][H_low][H_high][0x0A]
}
